...
class DetSolver(BaseSolver):
    ...
    def fit(self, ):
        ...
        for epoch in range(self.last_epoch + 1, args.epoches):
            ...
            print(f'\n{"="*80}')
            print(f'Starting Epoch {epoch+1}/{args.epoches}')
            print(f'{"="*80}')
            ...
            if 'coco_eval_bbox' in best_stat:
                ...
                print(f'{"-"*80}')
                print(f'  Best mAP: {best_mAP:.4f} (Epoch {best_epoch+1})')
