...
if __name__ == '__main__':
    model = RTDETR('/home/cjj/rtdetr_indoor/RTDETR-main/ultralytics/cfg/models/rt-detr/rtdetr-r18.yaml')
    #model.load('/home/cjj/rtdetr_indoor/RTDETR-main/weights/rtdetr-r18.pt') # loading pretrain weights
    model.train(data='/home/cjj/rtdetr_indoor/RTDETR-main/dataset/data.yaml',
                cache=False,
                imgsz=640,
                epochs=30,
                ...
                project='/home/cjj/rtdetr_indoor/RTDETR-main/runs/train',
                name='rtdetr-r18-indoor',
                )